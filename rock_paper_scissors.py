...
class RockPaperScissors:
	...
	def respond_to_user_input(self):
		...
		# rock, paper scissors to the numbers 0, 1, 2.
	...
	def create_message_text(self, game):
		...
		# Create the string for the message explaining the game number and add
		# it to the list of messages.
		self.messages.append(
			f'{self.settings.text_game_number}'
			f'{game["game_number"]+1}'
			)
		# Create the string for the message explaining the 
		# user input and add it to the list of messages.
		self.messages.append(
		...
		# choice and add it to the list of messages.
		self.messages.append(
			f'{self.settings.text_computer_picked}'
			f'{self.settings.rock_paper_scissors_mapping[game["computer_choice"]].title()}'
			)
		# Create the string for the message explaining the game result and add 
		# it to the list of messages.
		self.messages.append(
	...
	def update_scoreboard(self):
		"""
		Create the messages which will be shown on the scoreboard and 
		blit them to the screen.
		"""
		# Create the x and y coordinates for the scoreboard.
